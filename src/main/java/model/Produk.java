...
public class Produk {
    ...
    // 4. save() : Sekarang return boolean
    public boolean save() {
    ...
    // 5. update() : Sekarang return boolean
    public boolean update(ProdukData dataBaru) {
    ...
    // 6. delete() : Sekarang return boolean
    ...
    // 7. save(ProduksiHarian) : Return boolean
    public boolean save(ProduksiHarian ph) {
